...
class CoreHubUtilsTest {
    ...
    void getNonAhcCoreHubs() {
        CoreHub coreHubAhc1 = new CoreHub("AA", "AA", "AA", "AA", "AA", false, true, 0.0, Country.FR);
        CoreHub coreHubAhc2 = new CoreHub("BB", "BB", "BB", "BB", "BB", true, true, 0.0, Country.BE);
        CoreHub coreHub3 = new CoreHub("CC", "CC", "CC", "CC", "CC", true, false, 0.0, Country.DE);
        CoreHub coreHub4 = new CoreHub("DD", "DD", "DD", "DD", "DD", false, false, 0.0, Country.NL);
